...
const autoplay_button = document.getElementById('auto_play_button');
...
function play(users_choice) {
    let computers_choice = generate_random_choice();
    let winner;
...
function autoplay() {
    ...
    if (document.querySelector("#auto_play_button").innerText == 'Start Autoplay') {
        document.querySelector("#auto_play_button").innerHTML = 'Stop Autoplay';

        interval_id = setInterval(function () {
            play(generate_random_choice());
        }, 2000);
    }
    else{
        clearInterval(interval_id);
        document.querySelector("#auto_play_button").innerHTML = 'Start Autoplay';
    }
}